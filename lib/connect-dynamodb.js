...
module.exports = function (connect) {
  ...
  DynamoDBStore.prototype.setInternal = function (sid, sess, fn) {
  ...
  DynamoDBStore.prototype.set = function (sid, currentSess, fn) {
    this.get(sid, (err, persistedSession) => {
      const oldSession = persistedSession || {};

      const newSess = Object.assign({}, oldSession, currentSess);
      this.setInternal(sid, newSess, fn);
    });
  };
